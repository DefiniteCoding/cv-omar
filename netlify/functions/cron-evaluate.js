...
<public_info>
PUBLIC and SAFE to share: City (Dubai), Email (omarmostafapm@gmail.com), LinkedIn, GitHub, professional history.
</public_info>
...
async function sendAlertEmail(resend, alerts) {
  ...
  await resend.emails.send({
    from: 'Omar Bot <onboarding@resend.dev>',
