...
import { getArSlugs } from './articles/registry';
...
function CommTooltip({ playing, lang, dismissed }: { playing: boolean; lang: 'ar' | 'en'; dismissed?: boolean }) {
  const text = playing
    ? 'Uncharted Worlds'
    : dismissed
      ? (lang === 'ar' ? 'لا استجابة. نورماندي خارجة.' : 'Logging off. Normandy out.')
      : (lang === 'ar' ? 'قائد، لدينا إشارة' : 'Commander, we have a signal');
