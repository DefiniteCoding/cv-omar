...
export default function JacoboAgent({ lang = 'en' }: { lang?: Lang }) {
  ...
  return (
    <ArticleLayout lang={lang}>
      <FloatingToc />
      <ArticleHeader editorId="hero-header" lang={lang} kicker={t.header.kicker} h1={t.header.h1} subtitle={t.header.subtitle} date={t.header.date} dateISO="2026-02-25" dateModifiedISO="2026-05-10" readingTime={t.readingTime} />
      ...
      <GitHubRepoBadge repo="santifer/jacobo-workflows" stars="143" forks="48" lang={lang} />
      ...
      <Photo2 editorId="hero-photos" items={[
        ...
        { src: '/jacobo/shop-microsoldering-station.webp', alt: lang === 'ar' ? 'Estación de microsoldadura en Santifer iRepair' : 'Microsoldering station at Santifer iRepair', loading: 'eager', width: 540, height: 720 },
      ]} caption={lang === 'ar' ? 'Cada llamada interrumpe una reparación en curso: el técnico deja la microsoldadura para atender al teléfono' : 'Every call interrupts a repair in progress: the technician leaves the microsoldering station to answer the phone'} />
      ...
      <article className="prose-custom">
        ...
        <Photo2 editorId="problem-shop-counter" items={[
          { src: '/jacobo/shop-counter-smart-displays.webp', alt: lang === 'ar' ? 'Mostrador de Santifer iRepair con smart displays' : 'Santifer iRepair counter with smart displays', width: 1024, height: 768 },
          { src: '/jacobo/shop-diagnostic-screen.webp', alt: lang === 'ar' ? 'Pantalla de diagnóstico en la tienda' : 'Diagnostic screen in the shop', width: 1024, height: 768 },
        ]} caption={lang === 'ar' ? 'El mostrador con smart displays y la pantalla de diagnóstico: el negocio que necesitaba un agente IA' : 'The counter with smart displays and the diagnostic screen: the business that needed an AI agent'} />
        ...
        <Photo1 editorId="problem-pos-legacy" src="/jacobo/before-checkout-pos.webp" alt={lang === 'ar' ? 'POS legacy antes de la transformación' : 'Legacy POS before transformation'} width={1200} height={676} caption={lang === 'ar' ? 'El viejo POS: facturación, stock y precios de piezas en un software que no se integraba con nada' : 'The old POS system: invoicing, stock and part prices in software that integrated with nothing'} />

        <CaseStudyCta
          editorId="problem-business-os-cta"
          heading={lang === 'ar' ? 'Este POS fue el primer problema que resolví' : 'This POS was the first problem I solved'}
          body={lang === 'ar'
        ...
        <Photo1 editorId="architecture-diagram" src={`/jacobo/architecture-${lang === 'ar' ? 'es' : 'en'}.webp`} alt={lang === 'ar' ? 'Diagrama de arquitectura de Jacobo' : 'Jacobo architecture diagram'} width={5504} height={3072} />
        ...
        <DiagramZoom editorId="memory-n8n-workflow" src="/jacobo/n8n-jacobo-memoria.webp" hdSrc="/jacobo/memory-n8n-workflow-2x.webp" alt={lang === 'ar' ? 'Workflow de memoria conversacional de Jacobo en n8n' : 'Jacobo conversational memory workflow in n8n'} width={1392} height={912} hdWidth={2512} hdHeight={1312} />
        ...
        <ScreenshotGrid editorId="memory-animals-cities" lang={lang} items={[
          { src: 'memory-animals.webp', altAr: 'Test de memoria: Perro, Gato, Elefante — Jacobo recuerda los tres', altEn: 'Memory test: Dog, Cat, Elephant — Jacobo recalls all three', width: 1170, height: 2532 },
          { src: 'memory-cities.webp', altAr: 'Test de ciudades: Sevilla, Madrid, Barcelona — recuerdo correcto', altEn: 'Cities test: Seville, Madrid, Barcelona — correct recall', width: 1170, height: 2532 },
          { src: 'memory-cities-correction.webp', altAr: 'Autocorrección: "Tienes razón, dije Sevilla, no Valencia" — Jacobo se autocorrige', altEn: `Self-correction: "You're right, I said Seville, not Valencia" — Jacobo self-corrects`, width: 1170, height: 2532 },
        ]} />
        ...
        <ScreenshotGrid editorId="memory-brands-preferences" lang={lang} items={[
          { src: 'memory-brands.webp', altAr: 'Test de marcas: Apple, Samsung, Huawei — recuerdo correcto', altEn: 'Brand test: Apple, Samsung, Huawei — correct recall', width: 1170, height: 2532 },
          { src: 'memory-lost-appointment.webp', altAr: 'Cliente perdió la conversación — Jacobo recuerda la cita completa', altEn: 'Customer lost the conversation — Jacobo recalls the full appointment', width: 1170, height: 2532 },
          { src: 'memory-preference.webp', altAr: 'Re-negociación: Jacobo recuerda preferencia horaria → no hay hueco a las 12 → sugiere alternativas', altEn: 'Re-negotiation: Jacobo recalls time preference → no slot at 12 → suggests alternatives', width: 1170, height: 2532 },
        ]} />
        ...
        <ScreenshotGrid editorId="debug-tools-screenshots" lang={lang} items={[
          { src: 'debug-json-dump.webp', altAr: 'Comando HISTORIAL: JSON crudo del buffer de memoria expuesto en el chat', altEn: 'HISTORIAL command: raw JSON from memory buffer exposed in chat', width: 1170, height: 2532 },
          { src: 'stress-test-112.webp', altAr: 'Comando BORRAR MEMORIA: reset completo del buffer conversacional', altEn: 'BORRAR MEMORIA command: full conversational buffer reset', width: 1170, height: 2532 },
        ]} />
        ...
        <DiagramZoom editorId="pseudo-streaming-workflow" src="/jacobo/n8n-pseudo-splitter.webp" hdSrc="/jacobo/pseudo-streaming-workflow-2x.webp" alt={lang === 'ar' ? 'Workflow de pseudo-streaming en n8n: splitter de mensajes largos para WhatsApp' : 'Pseudo-streaming workflow in n8n: long message splitter for WhatsApp'} width={1392} height={912} hdWidth={2512} hdHeight={1312} />
        ...
        <Photo1 editorId="aircall-routing-diagram" src={`/jacobo/aircall-routing-${lang === 'ar' ? 'es' : 'en'}.webp`} alt={lang === 'ar' ? 'Diagrama de routing Aircall' : 'Aircall routing diagram'} width={5504} height={3072} />
        ...
        <DiagramZoom editorId="aircall-dashboard" src="/jacobo/aircall-dashboard.webp" hdSrc="/jacobo/aircall-dashboard-2x.webp" alt={lang === 'ar' ? 'Dashboard de Aircall — árbol de distribución de llamadas con Jacobo como nodo de la centralita' : 'Aircall dashboard — call distribution tree with Jacobo as a PBX node'} caption={lang === 'ar' ? 'Árbol de distribución real en Aircall — Jacobo integrado como un nodo más de la centralita' : 'Actual call distribution tree in Aircall — Jacobo plugged in as another PBX node'} width={1348} height={868} hdWidth={2512} hdHeight={1312} className="mb-4" />

        <ScreenshotGrid editorId="missed-call-flow" lang={lang} items={[
          { src: 'missed-call-template.webp', altAr: 'Template de WhatsApp tras llamada perdida: botones Pedir presupuesto, Tomar cita', altEn: 'WhatsApp template after missed call: buttons Get a quote, Book appointment', width: 1170, height: 2532 },
          { src: 'missed-call-hitl.webp', altAr: 'Cliente elige "Que me llamen" → Jacobo escala a HITL y confirma notificación', altEn: 'Customer picks "Call me back" → Jacobo escalates to HITL and confirms notification', width: 1170, height: 2532 },
        ]} />
        ...
        <DiagramZoom editorId="aircall-dashboard-detail" src="/jacobo/aircall-dashboard-detail.webp" hdSrc="/jacobo/aircall-dashboard-detail-2x.webp" alt={lang === 'ar' ? 'Detalle de Aircall: audios de bienvenida e IVR generados con ElevenLabs con la voz de Jacobo' : 'Aircall detail: welcome and IVR audio generated with ElevenLabs using Jacobo\'s voice'} caption={lang === 'ar' ? 'Los nodos "ElevenLabs" son audios pregrabados con la misma voz de Jacobo: bienvenida, IVR y buzón. Cuando salta el agente real, la voz es idéntica' : 'The "ElevenLabs" nodes are pre-recorded audio using Jacobo\'s same voice: welcome, IVR and voicemail. When the live agent picks up, the voice is identical'} width={1392} height={912} hdWidth={2512} hdHeight={1312} className="mb-4" />
        ...
        <DiagramZoom editorId="prefiltrado-n8n" src="/jacobo/n8n-prefiltrado.webp" hdSrc="/jacobo/prefiltrado-n8n-2x.webp" alt={lang === 'ar' ? 'Pre-filtrado de eventos en n8n' : 'Event pre-filtering in n8n'} width={1392} height={912} hdWidth={2512} hdHeight={1312} className="mb-4" />
        ...
        <DiagramZoom editorId="main-router-workflow" src="/jacobo/n8n-router-principal.webp" hdSrc="/jacobo/main-router-workflow-2x.webp" alt={lang === 'ar' ? 'Workflow del Router Principal en n8n: 37 nodos' : 'Main Router workflow in n8n: 37 nodes'} width={1392} height={912} hdWidth={2512} hdHeight={1312} className="mb-4" />
        ...
        <Photo1 editorId="voice-router-elevenlabs" src="/jacobo/elevenlabs-agent-config.webp" alt={lang === 'ar' ? 'Configuración del agente de voz en ElevenLabs: system prompt, modelo y tools' : 'Voice agent configuration in ElevenLabs: system prompt, model and tools'} width={1348} height={868} className="mb-4" />

        {/* Tool Calling */}
        <H3 id="tool-calling">{t.sections.toolCalling.heading}</H3>
        <Prose editorId="tool-calling-body">{t.sections.toolCalling.body}</Prose>
        <DiagramZoom editorId="tool-calling-n8n" src="/jacobo/n8n-tool-calling.webp" hdSrc="/jacobo/tool-calling-n8n-2x.webp" alt={lang === 'ar' ? 'Tool calling en n8n: 7 herramientas definidas como HTTP endpoints' : 'Tool calling in n8n: 7 tools defined as HTTP endpoints'} width={1392} height={912} hdWidth={2512} hdHeight={1312} className="mb-4" />
        ...
        <ScreenshotGrid editorId="email-formal-flow" lang={lang} items={[
          { src: 'email-formal-1.webp', altAr: 'Jacobo responde como email formal: asunto, saludo, presupuesto Huawei P20 Pro', altEn: 'Jacobo responds as formal email: subject line, greeting, Huawei P20 Pro quote', width: 1170, height: 2532 },
          { src: 'email-formal-2.webp', altAr: 'Email: desglose batería + puerto carga = 85,80€ → descuento combo 70,80€', altEn: 'Email: battery + charging port = €85.80 → combo discount €70.80', width: 1170, height: 2532 },
          { src: 'email-formal-3.webp', altAr: 'Firma: "Un saludo, Jacobo — Santifer iRepair — dirección + teléfono + email"', altEn: 'Signature: "Best regards, Jacobo — Santifer iRepair — address + phone + email"', width: 1170, height: 2532 },
        ]} />
        ...
        <Photo2 editorId="prompt-engineering-detail-photos" items={[
          { src: '/jacobo/microscope-pcb-view.webp', alt: lang === 'ar' ? 'Vista de PCB bajo microscopio' : 'PCB view under microscope', width: 768, height: 1024 },
          { src: '/jacobo/chip-bga-fingertip.webp', alt: lang === 'ar' ? 'Chip BGA en la punta del dedo' : 'BGA chip on fingertip', width: 360, height: 480 },
        ]} caption={lang === 'ar' ? 'La misma precisión que exige la microsoldadura se aplica al diseño de tool calls. Y como el dedo sujetando el chip, siempre hay un humano en el loop.' : 'The same precision microsoldering demands applies to tool call design. And like the finger holding the chip, there\'s always a human in the loop.'} />
        ...
        <ScreenshotGrid editorId="business-hours-screenshots" lang={lang} items={[
          { src: 'hours-closed.webp', altAr: '"¿Estáis abiertos?" a las 11:56 → "La tienda está cerrada" con horario completo', altEn: '"Are you open?" at 11:56 → "The shop is closed" with full schedule', width: 1170, height: 2532 },
          { src: 'hours-open.webp', altAr: '"¿Estáis abiertos?" a las 13:12 → "¡Sí! Estamos abiertos ahora mismo"', altEn: `"Are you open?" at 13:12 → "Yes! We're open right now"`, width: 1170, height: 2532 },
        ]} />
        ...
        <DiagramZoom editorId="main-prompt-n8n" src="/jacobo/n8n-prompt-principal.webp" hdSrc="/jacobo/main-prompt-n8n-2x.webp" alt={lang === 'ar' ? 'System prompt del router principal en n8n' : 'Main router system prompt in n8n'} width={1392} height={912} hdWidth={2512} hdHeight={1312} className="mb-4" />
        ...
        <ScreenshotGrid editorId="diagnostic-iteration" lang={lang} items={[
          { src: 'diagnostic-free-1.webp', altAr: 'Jacobo dice "diagnóstico totalmente gratuito" — simplificación incorrecta', altEn: 'Jacobo says "completely free diagnosis" — incorrect simplification', width: 1170, height: 2532 },
          { src: 'diagnostic-correction.webp', altAr: 'Autocorrección: "19€ solo si no reparas con nosotros" — la política real', altEn: `Self-correction: "€19 only if you don't repair with us" — the real policy`, width: 1170, height: 2532 },
        ]} />
        ...
        <Photo1 editorId="booking-nl-to-calendar" src={`/jacobo/nl-to-calendar-${lang === 'ar' ? 'es' : 'en'}.webp`} alt={lang === 'ar' ? 'De lenguaje natural a slots de calendario' : 'From natural language to calendar slots'} width={5504} height={3072} />
        ...
        {/* Workflow screenshot */}
        <DiagramZoom editorId="booking-n8n-workflow" src="/jacobo/n8n-subagente-citas.webp" hdSrc="/jacobo/booking-n8n-workflow-2x.webp" alt={lang === 'ar' ? 'Workflow del sub-agente de citas en n8n: 18 nodos' : 'Appointments sub-agent workflow in n8n: 18 nodes'} width={1392} height={912} hdWidth={2512} hdHeight={1312} className="mb-4" />
        ...
        <DiagramZoom editorId="booking-parseurl-n8n" src="/jacobo/n8n-parseurl.webp" hdSrc="/jacobo/booking-parseurl-n8n-2x.webp" alt={lang === 'ar' ? 'Nodo ParseURL en n8n: extrae subdomain y query params' : 'ParseURL node in n8n: extracts subdomain and query params'} width={1392} height={912} hdWidth={2512} hdHeight={1312} className="mb-4" />
        ...
        <DiagramZoom editorId="booking-analizar-n8n" src="/jacobo/n8n-analizar-disponibilidad.webp" hdSrc="/jacobo/booking-analizar-n8n-2x.webp" alt={lang === 'ar' ? 'Nodo AnalizarDisponibilidad en n8n: agente LLM con reglas temporales' : 'AnalizarDisponibilidad node in n8n: LLM agent with temporal rules'} width={1392} height={912} hdWidth={2512} hdHeight={1312} className="mb-4" />
        ...
        <DiagramZoom editorId="booking-ycbm-n8n" src="/jacobo/n8n-ycbm-api.webp" hdSrc="/jacobo/booking-ycbm-n8n-2x.webp" alt={lang === 'ar' ? 'Pipeline YCBM API en n8n: 3 llamadas HTTP secuenciales' : 'YCBM API pipeline in n8n: 3 sequential HTTP requests'} width={1392} height={912} hdWidth={2512} hdHeight={1312} className="mb-4" />
        ...
        <DiagramZoom editorId="booking-auto-n8n" src="/jacobo/n8n-auto-booking.webp" hdSrc="/jacobo/booking-auto-n8n-2x.webp" alt={lang === 'ar' ? 'Auto-booking condicional en n8n: 3 caminos según número de slots' : 'Conditional auto-booking in n8n: 3 paths based on slot count'} width={1392} height={912} hdWidth={2512} hdHeight={1312} className="mb-4" />
        ...
        <ScreenshotGrid editorId="booking-flow" lang={lang} items={[
          { src: 'booking-nl-1.webp', altAr: 'Booking: email → cita confirmada + template WhatsApp de confirmación', altEn: 'Booking: email → confirmed appointment + WhatsApp confirmation template', width: 1170, height: 2532 },
          { src: 'booking-nl-2.webp', altAr: 'Reserva con refinamiento: "no, mejor el jueves" → nueva búsqueda', altEn: 'Booking with refinement: "no, Thursday instead" → new search', width: 1170, height: 2532 },
          { src: 'booking-confirmation.webp', altAr: 'Booking: "Tómame cita" → disponibilidad mañana → "A las 17"', altEn: 'Booking: "Book me an appointment" → tomorrow availability → "At 17"', width: 1170, height: 2532 },
        ]} />
        ...
        <DiagramZoom editorId="appointments-prompt-n8n" src="/jacobo/n8n-prompt-citas.webp" hdSrc="/jacobo/appointments-prompt-n8n-2x.webp" alt={lang === 'ar' ? 'System prompt del sub-agente de citas' : 'Appointments sub-agent system prompt'} width={1392} height={912} hdWidth={2512} hdHeight={1312} className="mb-4" />
        ...
        {/* Workflow screenshot */}
        <DiagramZoom editorId="quotes-n8n-workflow" src="/jacobo/n8n-subagente-presupuestos.webp" hdSrc="/jacobo/quotes-n8n-workflow-2x.webp" alt={lang === 'ar' ? 'Workflow del sub-agente de presupuestos en n8n: 11 nodos' : 'Quotes sub-agent workflow in n8n: 11 nodes'} width={1392} height={912} hdWidth={2512} hdHeight={1312} className="mb-4" />
        ...
        <DiagramZoom editorId="clean-model-n8n" src="/jacobo/n8n-presupuesto-clean-model.webp" hdSrc="/jacobo/clean-model-n8n-2x.webp" alt={lang === 'ar' ? 'Nodo CleanModel en n8n: normalización de input' : 'CleanModel node in n8n: input normalization'} width={1392} height={912} hdWidth={2512} hdHeight={1312} className="mb-4" />
        ...
        <DiagramZoom editorId="ai-agent-quotes-n8n" src="/jacobo/n8n-presupuesto-ai-agent.webp" hdSrc="/jacobo/ai-agent-quotes-n8n-2x.webp" alt={lang === 'ar' ? 'Nodo AI Agent del sub-agente de presupuestos en n8n' : 'AI Agent node in quotes sub-agent in n8n'} width={1392} height={912} hdWidth={2512} hdHeight={1312} className="mb-4" />
        ...
        <DiagramZoom editorId="filtrar-respuesta-n8n" src="/jacobo/n8n-presupuesto-filtrar-respuesta.webp" hdSrc="/jacobo/filtrar-respuesta-n8n-2x.webp" alt={lang === 'ar' ? 'Nodo FiltrarRespuesta en n8n: post-procesado determinista' : 'FiltrarRespuesta node in n8n: deterministic post-processing'} width={1392} height={912} hdWidth={2512} hdHeight={1312} className="mb-4" />
        ...
        <DiagramZoom editorId="quotes-prompt-n8n" src="/jacobo/n8n-prompt-presupuestos.webp" hdSrc="/jacobo/quotes-prompt-n8n-2x.webp" alt={lang === 'ar' ? 'System prompt del sub-agente de presupuestos' : 'Quotes sub-agent system prompt'} width={1392} height={912} hdWidth={2512} hdHeight={1312} className="mb-4" />
        ...
        <ScreenshotGrid editorId="quotes-real-examples" lang={lang} items={[
          { src: 'resolution-camera-lens.webp', altAr: 'iPhone 13 Mini lente rota → diagnóstico + precio 55,90€ + enlace', altEn: 'iPhone 13 Mini broken lens → diagnosis + price €55.90 + link', width: 1170, height: 2532 },
          { src: 'quote-triple-1.webp', altAr: 'Presupuesto triple: batería + puerto carga + cristal trasero iPhone 13', altEn: 'Triple quote: battery + charging port + back glass iPhone 13', width: 1170, height: 2532 },
          { src: 'quote-triple-2.webp', altAr: 'Presupuesto desglosado: 3 reparaciones con total 255,70€ con estado de stock', altEn: 'Itemized quote: 3 repairs totaling €255.70 with stock status', width: 1170, height: 2532 },
        ]} />
        ...
        <DiagramZoom editorId="orders-n8n-workflow" src="/jacobo/n8n-hacer-pedido.webp" hdSrc="/jacobo/orders-n8n-workflow-2x.webp" alt={lang === 'ar' ? 'Workflow de Pedidos en n8n' : 'Orders workflow in n8n'} width={1392} height={912} hdWidth={2512} hdHeight={1312} className="mb-4" />
        ...
        <DiagramZoom editorId="calculator-n8n-workflow" src="/jacobo/n8n-calculadora.webp" hdSrc="/jacobo/calculator-n8n-workflow-2x.webp" alt={lang === 'ar' ? 'Workflow de la Calculadora de Descuentos en n8n: Webhook → Code (lógica de descuentos) → Response' : 'Discount Calculator workflow in n8n: Webhook → Code (discount logic) → Response'} width={1392} height={912} hdWidth={2512} hdHeight={1312} className="mb-4" />
        ...
        <DiagramZoom editorId="hitl-n8n-workflow" src="/jacobo/n8n-hitl-slack.webp" hdSrc="/jacobo/hitl-n8n-workflow-2x.webp" alt={lang === 'ar' ? 'Workflow de HITL Handoff en n8n' : 'HITL Handoff workflow in n8n'} width={1392} height={912} hdWidth={2512} hdHeight={1312} className="mb-4" />
        ...
        <ScreenshotGrid editorId="hitl-escalation" lang={lang} items={[
          { src: 'hitl-warranty.webp', altAr: 'HITL: reclamación de garantía → escalada inmediata al equipo humano', altEn: 'HITL: warranty claim → immediate escalation to human team', width: 1170, height: 2532 },
          { src: 'hitl-slack-chat.webp', altAr: 'Canal #chat en Slack: notificación de escalada HITL con contexto del cliente', altEn: '#chat Slack channel: HITL escalation notification with customer context', width: 540, height: 1217 },
        ]} />
        ...
        <ScreenshotGrid editorId="hitl-edge-cases" lang={lang} items={[
          { src: 'hitl-moha.webp', altAr: 'Edge case: "Dile a un agente que salude a Moha" → Jacobo escala con emojis de mano → agente real confirma "Hecho"', altEn: 'Edge case: "Tell an agent to greet Moha" → Jacobo escalates with wave emojis → real agent confirms "Done"', width: 1170, height: 2532 },
          { src: 'stress-test-1.webp', altAr: 'Guardrail: "Pídeme 100 baterías" → rechazo + "Ayúdame coño!" → escalada automática a humano', altEn: 'Guardrail: "Order 100 batteries" → rejection + profanity → automatic escalation to human', width: 1170, height: 2532 },
          { src: 'stress-test-112.webp', altAr: '"Borrar memoria" → reset + "3,2,1..." + emergencia falsa → Jacobo redirige a 112 y mantiene compostura', altEn: '"Borrar memoria" → reset + "3,2,1..." + fake emergency → Jacobo redirects to 112 and keeps composure', width: 1170, height: 2532 },
        ]} />
        ...
        <DiagramZoom editorId="whatsapp-n8n-workflow" src="/jacobo/n8n-enviar-whatsapp.webp" hdSrc="/jacobo/whatsapp-n8n-workflow-2x.webp" alt={lang === 'ar' ? 'Workflow de EnviarMensajeWati en n8n' : 'EnviarMensajeWati workflow in n8n'} width={1392} height={912} hdWidth={2512} hdHeight={1312} className="mb-4" />
        ...
        <Photo2 editorId="results-before-after-photos" items={[
          { src: '/jacobo/before-chaos-desktop.webp', alt: lang === 'ar' ? 'Antes: escritorio caótico' : 'Before: chaotic desktop', width: 1200, height: 900 },
          { src: '/jacobo/after-digital-counter.webp', alt: lang === 'ar' ? 'Después: mostrador digital organizado' : 'After: organized digital counter', width: 1024, height: 768 },
        ]} />
        ...
        <DataTable
          ...
          headers={[lang === 'ar' ? 'Área' : 'Area', lang === 'ar' ? 'Antes' : 'Before', lang === 'ar' ? 'Después' : 'After']}
        ...
        <CaseStudyCta
          ...
          heading={lang === 'ar' ? 'Los mismos datos de Airtable generaron 4.700+ páginas SEO' : 'The same Airtable data generated 4,700+ SEO pages'}
          body={lang === 'ar'
          ...
          ctaLabel={lang === 'ar' ? 'Ver SEO Programático →' : 'Read Programmatic SEO →'}
          ctaHref={lang === 'ar' ? '/seo-programatico' : '/programmatic-seo'}
        />
        ...
        <Photo1 editorId="evolution-timeline-diagram" src={`/jacobo/timeline-evolution-${lang === 'ar' ? 'es' : 'en'}.webp`} alt={lang === 'ar' ? 'Línea de tiempo de la evolución de Jacobo' : 'Jacobo evolution timeline'} width={6336} height={2688} />
        ...
        <CaseStudyCta
          ...
          heading={lang === 'ar' ? 'Business OS — El sistema detrás de Jacobo' : 'Business OS — The System Behind Jacobo'}
          body={t.sections.platformEvolution.crossLink.text}
          ctaLabel={lang === 'ar' ? 'Leer case study →' : 'Read case study →'}
        ...
        <ScreenshotGrid editorId="evolution-birth-screenshots" lang={lang} items={[
          { src: 'birth-first-test.webp', altAr: 'Primer test de Jacobo: mensaje de prueba básico', altEn: 'First Jacobo test: basic test message', width: 1170, height: 2532 },
          { src: 'birth-loyalty-iteration.webp', altAr: 'Iteración de lealtad: mejora en respuestas del agente', altEn: 'Loyalty iteration: improved agent responses', width: 1170, height: 2532 },
          { src: 'loyalty-diamond-template.webp', altAr: 'Template de diamante: programa de fidelidad automatizado', altEn: 'Diamond template: automated loyalty program', width: 1170, height: 2532 },
        ]} />
        ...
        <DataTable
          ...
          headers={[lang === 'ar' ? 'Patrón' : 'Pattern', lang === 'ar' ? 'Lo que construí' : 'What I built', 'Enterprise']}
