...
const SOCIAL_LINKS: { name: string; url: string; rel?: string }[] = [
  ...
  { name: 'LinkedIn', url: 'https://www.linkedin.com/in/omar-mostafa-mohaseb', rel: 'me noopener noreferrer' },
  ...
  return (
    <div className="min-h-screen bg-background text-foreground bg-[length:24px_24px] [background-image:radial-gradient(circle,hsl(var(--dot-grid))_1px,transparent_1px)]">
      <main className="max-w-2xl mx-auto px-4 sm:px-6 py-12 md:py-20">
        ...
        {/* Manifesto */}
        <blockquote cite="https://omarmostafa.org/career-ops" className="mb-10 border-l-4 border-primary pl-6 pr-4 py-3 text-xl md:text-2xl italic font-display leading-snug text-foreground/90">
          {t.manifesto}
        </blockquote>
