...
exifObj['Exif'][piexif.ExifIFD.UserComment] = userComment.toString('binary');`,
      ...
      imagePipeline: {
        ...
        overlayShowcase: {
          ...
          items: [
            { src: 'pantalla.png', altAr: 'Overlay de reparación de pantalla', altEn: 'Screen repair overlay' },
            { src: 'bateria.png', altAr: 'Overlay de cambio de batería', altEn: 'Battery replacement overlay' },
            { src: 'camara-trasera.png', altAr: 'Overlay de cámara trasera', altEn: 'Rear camera overlay' },
            { src: 'puerto-carga.png', altAr: 'Overlay de puerto de carga', altEn: 'Charging port overlay' },
            { src: 'tapa-trasera.png', altAr: 'Overlay de tapa trasera', altEn: 'Back cover overlay' },
            { src: 'cristal.png', altAr: 'Overlay de cambio de cristal', altEn: 'Glass replacement overlay' },
          ],
        },
        compositionProcess: {
  ...
  .toFile(outputPath)`,
        ...
        onePhotoDemo: {
          ...
          variants: [
            { src: 'cambiar-pantalla-apple-iphone-14-pro.webp', altAr: 'Cambiar pantalla iPhone 14 Pro', altEn: 'iPhone 14 Pro screen replacement' },
            { src: 'cambiar-bateria-apple-iphone-14-pro.webp', altAr: 'Cambiar batería iPhone 14 Pro', altEn: 'iPhone 14 Pro battery replacement' },
            { src: 'cambiar-camara-trasera-apple-iphone-14-pro.webp', altAr: 'Cambiar cámara trasera iPhone 14 Pro', altEn: 'iPhone 14 Pro rear camera replacement' },
            { src: 'cambiar-puerto-carga-apple-iphone-14-pro.webp', altAr: 'Cambiar puerto de carga iPhone 14 Pro', altEn: 'iPhone 14 Pro charging port replacement' },
            { src: 'cambiar-tapa-trasera-apple-iphone-14-pro.webp', altAr: 'Cambiar tapa trasera iPhone 14 Pro', altEn: 'iPhone 14 Pro back cover replacement' },
            { src: 'cambiar-cristal-apple-iphone-14-pro.webp', altAr: 'Cambiar cristal iPhone 14 Pro', altEn: 'iPhone 14 Pro glass replacement' },
            { src: 'cambiar-altavoz-apple-iphone-14-pro.webp', altAr: 'Cambiar altavoz iPhone 14 Pro', altEn: 'iPhone 14 Pro speaker replacement' },
            { src: 'cambiar-microfono-apple-iphone-14-pro.webp', altAr: 'Cambiar micrófono iPhone 14 Pro', altEn: 'iPhone 14 Pro microphone replacement' },
            { src: 'cambiar-auricular-apple-iphone-14-pro.webp', altAr: 'Cambiar auricular iPhone 14 Pro', altEn: 'iPhone 14 Pro earpiece replacement' },
          ],
          caption: {
  ...
  .update(record.id, {
    'imagen_procesada': outputUrl
        ...
        profileDemo: {
          ...
          items: [
            { src: 'victor.webp', altAr: 'Víctor — reparación de pantalla Samsung Galaxy A70', altEn: 'Victor — Samsung Galaxy A70 screen repair' },
            { src: 'sarah.webp', altAr: 'Sarah — reparación de auricular iPhone 11', altEn: 'Sarah — iPhone 11 earpiece repair' },
            { src: 'cristina.webp', altAr: 'Cristina — reparación de auricular iPhone 12', altEn: 'Cristina — iPhone 12 earpiece repair' },
            { src: 'ricardo.webp', altAr: 'Ricardo — cambio de batería Google Pixel 4', altEn: 'Ricardo — Google Pixel 4 battery replacement' },
            { src: 'manolo.webp', altAr: 'Manolo — reparación de batería iPhone 11 Pro Max', altEn: 'Manolo — iPhone 11 Pro Max battery repair' },
            { src: 'fernando.webp', altAr: 'Fernando — reparación de táctil iPad 5', altEn: 'Fernando — iPad 5 touch repair' },
            { src: 'susana.webp', altAr: 'Susana — reparación de pantalla iPhone XS', altEn: 'Susana — iPhone XS screen repair' },
            { src: 'teresa.webp', altAr: 'Teresa — reparación de pantalla iPhone 8 Plus', altEn: 'Teresa — iPhone 8 Plus screen repair' },
            { src: 'luisa.webp', altAr: 'Luisa — reparación de batería iPhone 6 Plus', altEn: 'Luisa — iPhone 6 Plus battery repair' },
          ],
          caption: {
