...
Presupuesto reparándolo todo junto: \${totalConDescuento.toFixed(2)} €\`;`,
      ...
      ctaAfterEnterprise: {
        heading: 'Estos patrones escalan. Listos para producción enterprise.',
      },
      ctaAfterDownloads: {
      ...
      faq: {
        ...
        items: [
          ...
          {
            q: '¿Cómo aplican estos patrones a un equipo enterprise?',
            a: 'Construí Jacobo en una PYME, pero los patrones (sub-agentes, tool calling, HITL, cross-channel) son enterprise-grade. A escala añades: circuit breakers, A/B testing por sub-agente, queue management para HITL, observabilidad por sub-agente. Lo que no cambia: la arquitectura.',
          },
        ],
      },
      resources: {
      ...
      faq: {
        ...
        items: [
          ...
          },
          {
            ...
            a: 'Jacobo was built for an SMB, but the patterns (sub-agents, tool calling, HITL, cross-channel) are enterprise-grade. At scale you add: circuit breakers, A/B testing per sub-agent, queue management for HITL handoff, per-sub-agent observability. What does not change: the architecture.',
          },
        ],
      },
      resources: {
