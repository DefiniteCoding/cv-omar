...
function ScreenshotFigure({ src, alt, summaryEn, lang, width, height, className }: { src: string; alt: string; summaryEn: string; lang: 'ar' | 'en'; width?: number; height?: number; className?: string }) {
...
export function ScreenshotCaption({ ar, en, lang, editorId }: ScreenshotCaptionProps) {
  return (
    <EditorLabel name="ScreenshotCaption" id={editorId}>
      <p className="text-xs text-muted-foreground mb-6 -mt-4 px-1">{lang === 'ar' ? ar : en}</p>
    </EditorLabel>
  )
}
