 ...
 */
export default function ArchitectureDiagram({ lang = 'en' }: { lang?: 'ar' | 'en' }) {
  const ar = lang === 'ar'
  const l = {
    title: ar ? 'Arquitectura del Business OS' : 'Business OS Architecture',
    subtitle: ar ? '12 bases interconectadas · 2.100+ campos · 50+ automatizaciones' : '12 interconnected bases · 2,100+ fields · 50+ automations',
    erp: ar ? 'ERP Central' : 'Central ERP',
    erpSub: ar ? 'OTS · Inventario · Compras · Reservas · Garantías' : 'OTS · Inventory · Purchasing · Bookings · Warranties',
    erpBadge: ar ? '496 campos' : '496 fields',
    crm: 'CRM',
    crmSub: ar ? 'Clientes · Scoring · Tiers' : 'Customers · Scoring · Tiers',
    accounting: ar ? 'Contabilidad' : 'Accounting',
    accountingSub: ar ? 'Facturas · Conciliación · Gastos' : 'Invoices · Reconciliation · Expenses',
    cms: ar ? 'CMS Web' : 'Web CMS',
    cmsSub: ar ? '1.534 campos · 647 fórmulas' : '1,534 fields · 647 formulas',
    parts: ar ? 'Catálogo Piezas' : 'Parts Catalog',
    accessories: ar ? 'Catálogo Accesorios' : 'Accessories Catalog',
    feedback: 'Feedback',
    reviews: ar ? 'Reseñas' : 'Reviews',
    kwr: ar ? 'KWR Auto' : 'Auto KWR',
    gbp: ar ? 'Posts GBP' : 'GBP Posts',
    content: ar ? 'Contenido' : 'Content',
    gpt: 'Custom GPT',
    automations: ar ? '50+ Automatizaciones nativas de Airtable' : '50+ Native Airtable Automations',
    legendHub: ar ? 'Hub central' : 'Central hub',
    legendCore: ar ? 'Módulos core' : 'Core modules',
    legendData: ar ? 'Catálogos' : 'Catalogs',
    legendSatellite: ar ? 'Satélites' : 'Satellites',
  }
